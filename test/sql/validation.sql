...
CALL diffix.make_personal('test_validation', '646966666978', 'id');

CREATE TABLE superclass (x INTEGER);
CREATE TABLE subclass (x INTEGER, y INTEGER);
INSERT INTO subclass VALUES (1, 2);

CALL diffix.make_personal('superclass', '646966666978', 'x');
CALL diffix.make_personal('subclass', '646966666978', 'y');
