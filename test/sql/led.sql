...
SECURITY LABEL FOR pg_diffix ON TABLE led_base IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN led_base.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE led_with_victim IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN led_with_victim.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE led_with_two_victims IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN led_with_two_victims.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE led_with_three_cs_women IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN led_with_three_cs_women.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE led_with_different_titles IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN led_with_different_titles.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE led_with_star_bucket IS 'sensitive:646966666978';
