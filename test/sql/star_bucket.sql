...
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_base IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_base.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_suppressed_1 IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_suppressed_1.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_suppressed_2 IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_suppressed_2.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_empty IS 'sensitive:646966666978';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_empty.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_only IS 'sensitive:646966666978';
