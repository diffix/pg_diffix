...
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_base IS 'sensitive';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_base.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket IS 'sensitive';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_suppressed_1 IS 'sensitive';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_suppressed_1.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_suppressed_2 IS 'sensitive';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_suppressed_2.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_empty IS 'sensitive';
SECURITY LABEL FOR pg_diffix ON COLUMN star_bucket_empty.id IS 'aid';
SECURITY LABEL FOR pg_diffix ON TABLE star_bucket_only IS 'sensitive';
