...
#define CS_STATE_GETARG CS_MAKE_NAME(state_getarg)
...
CS_SCOPE CS_CONTRIBUTION_STATE *CS_STATE_GETARG(PG_FUNCTION_ARGS, int index);
...
CS_SCOPE CS_CONTRIBUTION_STATE *CS_STATE_GETARG(PG_FUNCTION_ARGS, int index)
{
  ...
  {
    return (CS_CONTRIBUTION_STATE *)PG_GETARG_POINTER(index);
  }
